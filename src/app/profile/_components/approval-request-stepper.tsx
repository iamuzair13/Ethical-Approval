          ...
          <div className="min-h-0 flex-1 overflow-y-auto p-6">
            ...
            {false && formMode === "form3-thesis-medical" && currentStep === 0 && (
              <section className="grid gap-6">
                ...
                <div className="grid gap-4 rounded-lg border border-stroke p-4 dark:border-dark-3 md:grid-cols-2">
                  ...
                  <input value={form.thesisTitle} onChange={onFieldChange("thesisTitle")} placeholder="Thesis/Project Title" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />
                  <input value={form.researchDiscipline} onChange={onFieldChange("researchDiscipline")} placeholder="Research Discipline" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white" />
                  <input value={form.fundingSource} onChange={onFieldChange("fundingSource")} placeholder="Funding Source (if applicable)" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white" />
                  <input type="date" value={form.expectedStartDate} onChange={onFieldChange("expectedStartDate")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white" />
                  <input type="date" value={form.expectedEndDate} onChange={onFieldChange("expectedEndDate")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white" />
                  <input value={form.researchLocations} onChange={onFieldChange("researchLocations")} placeholder="Research Location(s)" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />
                  <textarea value={form.researchObjective1} onChange={onFieldChange("researchObjective1")} rows={2} placeholder="Describe" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />
                  <textarea value={form.researchObjective2} onChange={onFieldChange("researchObjective2")} rows={2} placeholder="Describe" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />
                  <textarea value={form.researchObjective3} onChange={onFieldChange("researchObjective3")} rows={2} placeholder="Describe" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />
                  <textarea value={form.researchObjective4} onChange={onFieldChange("researchObjective4")} rows={2} placeholder="Describe" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />
                  <textarea value={form.methodology} onChange={onFieldChange("methodology")} rows={4} placeholder="Research Methodology (Methods and Materials)" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />
                  <div><p className="mb-2 text-sm font-semibold text-dark dark:text-white">How many participant will you be recruiting? (Estimated Number)</p><select value={form.participantsEstimate} onChange={onFieldChange("participantsEstimate")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">How many participant will you be recruiting?(Estimated Number)</option><option>1-20</option><option>21-50</option><option>51-100</option><option>101-150</option><option>151-200</option><option>201-300</option><option>301-400</option><option>401-500</option><option>501+</option></select></div>
                </div>
              </section>
            )}
            ...
            {false && formMode === "form3-thesis-medical" && currentStep === 1 && (
              <section className="grid gap-4 md:grid-cols-2">
                ...
                <select value={form.involveHumanParticipants} onChange={onFieldChange("involveHumanParticipants")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                <select value={form.collectPii} onChange={onFieldChange("collectPii")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                ...
                <select value={form.informedConsentType} onChange={onFieldChange("informedConsentType")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Oral informed consent (with witness)</option><option>Waiver of consent</option><option>Not applicable</option></select>
                <select value={form.preApprovalDataCollected} onChange={onFieldChange("preApprovalDataCollected")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                <select value={form.canWithdraw} onChange={onFieldChange("canWithdraw")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                <select value={form.compensation} onChange={onFieldChange("compensation")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                <textarea value={form.adverseEventsManagement} onChange={onFieldChange("adverseEventsManagement")} rows={3} placeholder="2.9 Adverse events / complaint management" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />
                <select value={form.publicationBiologicalSpecimens} onChange={onFieldChange("publicationBiologicalSpecimens")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                {form.publicationBiologicalSpecimens === "Yes" && <textarea value={form.publicationBiologicalSpecimenDetails} onChange={onFieldChange("publicationBiologicalSpecimenDetails")} rows={2} placeholder="Describe biosafety collection/storage/handling." className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />}
                <select value={form.researchRiskLevel} onChange={onFieldChange("researchRiskLevel")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Minimal risk</option><option>Low risk</option><option>Moderate risk</option><option>High risk</option></select>
                {(form.researchRiskLevel === "Moderate risk" || form.researchRiskLevel === "High risk") && <textarea value={form.researchRiskJustification} onChange={onFieldChange("researchRiskJustification")} rows={2} placeholder="Justify selected risk level." className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />}
                <textarea value={form.potentialRiskDetails} onChange={onFieldChange("potentialRiskDetails")} rows={2} placeholder="2.12 Potential risks and adverse effects" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />
                <select value={form.conflictOfInterest} onChange={onFieldChange("conflictOfInterest")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option><option>Undecided</option></select>
                {form.conflictOfInterest === "Yes" && <textarea value={form.conflictManagement} onChange={onFieldChange("conflictManagement")} rows={2} placeholder="Describe." className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />}
              </section>
            )}
            ...
            {false && formMode === "form3-thesis-medical" && currentStep === 2 && (
              <section className="grid gap-4 md:grid-cols-2">
                ...
                <select value={form.publicationPharmaInterventions} onChange={onFieldChange("publicationPharmaInterventions")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                <input value={form.drugName} onChange={onFieldChange("drugName")} placeholder="Enter Details" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white" />
                <input value={form.drugDosageFrequency} onChange={onFieldChange("drugDosageFrequency")} placeholder="Enter..." className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white" />
                <input value={form.drugKnownSideEffects} onChange={onFieldChange("drugKnownSideEffects")} placeholder="Enter..." className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />
                <select value={form.drugRegulatoryApproval} onChange={onFieldChange("drugRegulatoryApproval")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option><option>Pending</option><option>Not Applicable</option></select>
                <select value={form.monitoredAfterAdministration} onChange={onFieldChange("monitoredAfterAdministration")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option><option>Not Applicable</option></select>
                {form.monitoredAfterAdministration === "Yes" && <input value={form.followUpDuration} onChange={onFieldChange("followUpDuration")} placeholder="Follow-up duration" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white" />}
                <textarea value={form.emergencyProcedures} onChange={onFieldChange("emergencyProcedures")} rows={3} placeholder="3.6 Has regulatory and ethical approval been obtained for the pharmaceutical substance / investigational product?" className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />
                <select value={form.publicationAnimalSubjects} onChange={onFieldChange("publicationAnimalSubjects")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                <select value={form.publicationAnimalEthicsApproval} onChange={onFieldChange("publicationAnimalEthicsApproval")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option><option>Pending</option><option>Not Applicable</option></select>
              </section>
            )}
            ...
            {false && formMode === "form3-thesis-medical" && currentStep === 3 && (
              <section className="grid gap-4 md:grid-cols-2">
                ...
                <select value={form.sharedWithThirdParties} onChange={onFieldChange("sharedWithThirdParties")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                {form.sharedWithThirdParties === "Yes" && <textarea value={form.thirdPartySharingDetails} onChange={onFieldChange("thirdPartySharingDetails")} rows={2} placeholder="Institution, purpose, safeguards." className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />}
                <select value={form.cloudPlatformsUsed} onChange={onFieldChange("cloudPlatformsUsed")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                {form.cloudPlatformsUsed === "Yes" && <input value={form.cloudPlatformDetails} onChange={onFieldChange("cloudPlatformDetails")} placeholder="Enter..." className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white" />}
                <select value={form.futureResearchDataUse} onChange={onFieldChange("futureResearchDataUse")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                {form.futureResearchDataUse === "Yes" && <textarea value={form.futureResearchDataUseConditions} onChange={onFieldChange("futureResearchDataUseConditions")} rows={2} placeholder="Specify conditions." className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />}
                <select value={form.dataRetentionYears} onChange={onFieldChange("dataRetentionYears")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>1-5 years</option><option>6-10 years</option><option>11-15 years</option><option>More than 16 years</option></select>
                {form.dataRetentionYears === "More than 16 years" && <textarea value={form.longRetentionReason} onChange={onFieldChange("longRetentionReason")} rows={2} placeholder="Explain longer retention need." className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white" />}
              </section>
            )}
            ...
            {false && formMode === "form3-thesis-medical" && currentStep === 4 && (
              <section className="grid gap-4 md:grid-cols-2">
                ...
                <select value={form.institutionalFunding} onChange={onFieldChange("institutionalFunding")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select </option><option>Yes</option><option>No</option></select>
                <select value={form.externalFunding} onChange={onFieldChange("externalFunding")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
                <select value={form.internationalCollaboration} onChange={onFieldChange("internationalCollaboration")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select </option><option>Yes</option><option>No</option></select>
                {form.internationalCollaboration === "Yes" && <textarea value={form.internationalCollaborationDetails} onChange={onFieldChange("internationalCollaborationDetails")} rows={3} placeholder="Provide collaboration details." className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white md:col-span-2" />}
                <select value={form.conductedAbroad} onChange={onFieldChange("conductedAbroad")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white"><option value="">Select</option><option>Yes</option><option>No</option></select>
              </section>
            )}
            ...
            {false && formMode === "form3-thesis-medical" && currentStep === 6 && (
              <section className="grid gap-4">
                ...
                <input type="date" value={form.submissionDate} onChange={onFieldChange("submissionDate")} className="rounded-lg border border-stroke bg-transparent px-4 py-2.5 text-dark dark:border-dark-3 dark:bg-gray-dark dark:text-white" />
              </section>
            )}
