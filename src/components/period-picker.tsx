        ...
        <ul>
          {(items || ["monthly", "yearly"]).map((item) => (
            <li key={`${sectionKey}-${item}`}>
              <button
                className="flex w-full select-none items-center truncate rounded-md px-3 py-2 text-sm capitalize text-dark-5 outline-none hover:bg-[#F9FAFB] hover:text-dark-3 dark:text-white dark:hover:bg-[#FFFFFF1A] dark:hover:text-white"
                onClick={() => {
